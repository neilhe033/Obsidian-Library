...
> [!definition] Subsets of ℝ ^subsets_of_R  
> alias:: subsets of R, subset of R, ℝ subsets, real subsets
...
> [!definition] Natural Number ^def_natural_number  
